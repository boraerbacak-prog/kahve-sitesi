      ...
      <div className="max-w-4xl mx-auto px-6 -mt-10">
        ...
        <div className="bg-white rounded-xl border border-amber-100 p-8 shadow-lg mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { tier: "Bronz", color: "amber", range: "0 - 500 ₺", discount: "%0", ship: `${settings.bronzeShippingThreshold} ₺ üzeri`, puan: "×1 kazanç" },
              { tier: "Gümüş", color: "gray", range: "500 - 2.000 ₺", discount: `%${settings.silverDiscountPct}`, ship: settings.silverShippingThreshold > 0 ? `${settings.silverShippingThreshold} ₺ üzeri` : "Bedava", puan: "×1.2 kazanç" },
              { tier: "Altın", color: "yellow", range: "2.000 ₺+", discount: `%${settings.goldDiscountPct}`, ship: settings.goldShippingThreshold === 0 ? "Bedava" : `${settings.goldShippingThreshold} ₺ üzeri`, puan: "×1.5 kazanç" },
            ].map((t) => (

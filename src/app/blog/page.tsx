  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-24">
      <div className="text-center mb-16">
        <span className="text-xs tracking-[0.2em] uppercase text-primary font-medium">Güncel</span>
        <h1 className="text-4xl sm:text-5xl font-bold text-heading mt-3 mb-4">Akademi</h1>

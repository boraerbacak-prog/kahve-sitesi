  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-24">
      <div className="text-center mb-16">
        <span className="text-xs tracking-[0.2em] uppercase text-primary font-medium">Rehber</span>
        <h1 className="text-4xl sm:text-5xl font-bold text-heading mt-3 mb-4">Demleme Teknikleri</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {methods.map((method) => (
          <Link
            ...
            className="group bg-white border border-border overflow-hidden hover:border-primary/30 hover:shadow-lg transition-all"
          >
            ...
            <div className="p-6">
              <h2 className="text-xl font-bold text-heading mb-2">{method.title}</h2>
              <p className="text-body text-sm leading-relaxed">{method.desc}</p>
              <span className="inline-block mt-4 text-xs tracking-[0.2em] uppercase text-primary font-medium group-hover:gap-2 transition-all">
                İncele →
              </span>
            </div>
          </Link>
